 ...
 * @author Carlos Mario
 */
public class ApiBloqueosAdministrativo {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        try {
            ...
            String endpoint = baseUrl + "/api/bloqueos/administrativos";
    ...
    public boolean eliminar(Long idbloqueo) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/bloqueos/eliminar/administrativo/" + idbloqueo);
    ...
    public boolean insertar(BloqueosAdministrativoDTO dto) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/bloqueos/insertar/administrativo");
    ...
    public boolean editar(Long id, BloqueosAdministrativoDTO dto) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/bloqueos/editar/administrativo/" + id);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
