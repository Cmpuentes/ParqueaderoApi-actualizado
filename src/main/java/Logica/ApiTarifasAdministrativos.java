 ...
 * @author Carlos Mario
 */
public class ApiTarifasAdministrativos {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        try {
            ...
            String endpoint = baseUrl + "/api/tarifas/administrativos";
    ...
    public boolean insertar(TarifasAdminResDTO dto) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/tarifas");
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public boolean editar(Long id, TarifasAdminResDTO dts) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/tarifas/" + id);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
