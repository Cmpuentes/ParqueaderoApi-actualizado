...
public class EmpleadoService {
    ...
    public DefaultTableModel mostrarp(String buscar) {
        ...
        try {
            ...
            String endpoint = baseUrl + "/api/escritorio/empleados";
    ...
    public boolean insertar(EmpleadoAdminDTO empleado) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/escritorio/empleados");
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public boolean editar(Integer id, EmpleadoAdminDTO dto) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/escritorio/empleados/" + id);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    //VALIDAR EL LOGIN DEL ADMINISTRADOR
