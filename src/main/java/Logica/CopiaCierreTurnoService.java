 ...
 * @author Carlos Mario
 */
public class CopiaCierreTurnoService {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        try {
            ...
            String endpoint = baseUrl + "/salida_turno/escritorio";
    ...
    public SalidaTurnoPrintDTO obtenerPorNumeroTurno(String numTurno) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/salida_turno/escritorio/numero/" + numTurno);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public void imprimirFilaSeleccionada(JTable tablalistadoCopiaTurno) throws IOException, PrinterException {
        ...
        CopiaCierreTurnoService api = new CopiaCierreTurnoService();
