...
public class ApiZonaP {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        try {
            ...
            String endpoint = baseUrl + "/api/zonas";
    ...
    public boolean insertar(ZonaAdminDTO dts) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/zonas");
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public boolean editar(Long id, ZonaAdminDTO dts) {
        try {
            String baseUrl = ConfiguradorApi.getInstance().getApiBaseUrl();
            URL url = new URL(baseUrl + "/api/zonas/" + id);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
