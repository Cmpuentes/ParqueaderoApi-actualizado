 ...
 * @author alexn
 */
public class Estilo_pestañas2UI extends BasicTabbedPaneUI{
    
     private final Estilo_Pestañas  tab;

    public Estilo_pestañas2UI(Estilo_Pestañas  tab) {
        this.tab = tab;
    }
    ...
    protected void paintTabBackground(Graphics2D g2, int index, boolean selected) {
        ...
        g2.drawImage(new Estilo_pestañas_render(6, 0.8f, new Color(50, 50, 50)).createShadow(shape), rec.x, rec.y, null);
        g2.fill(shape);
    }
